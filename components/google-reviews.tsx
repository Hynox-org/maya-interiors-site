      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 px-4">
          <a
            ...
            className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-[#8BA186] hover:bg-[#7a9177] text-white px-8 py-4 rounded-full text-base font-semibold transition-all duration-300 shadow-[0_10px_30px_rgba(139,161,134,0.3)] hover:shadow-[0_15px_40px_rgba(139,161,134,0.4)] hover:-translate-y-0.5 active:translate-y-0"
          >
            <FaGoogle className="w-6 h-6 flex-shrink-0" />
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-[#8BA186] hover:bg-[#7a9177] text-white px-8 py-4 rounded-full text-base font-semibold transition-all duration-300 shadow-[0_10px_30px_rgba(139,161,134,0.3)] hover:shadow-[0_15px_40px_rgba(139,161,134,0.4)] hover:-translate-y-0.5 active:translate-y-0"
          >
            <FaDirections className="w-6 h-6 flex-shrink-0" />
          ...
          <Link
            ...
            className="w-full sm:w-auto inline-flex justify-center items-center gap-2 bg-[#8BA186] hover:bg-[#7a9177] text-white px-8 py-4 rounded-full text-base font-semibold transition-all duration-300 shadow-[0_10px_30px_rgba(139,161,134,0.3)] hover:shadow-[0_15px_40px_rgba(139,161,134,0.4)] hover:-translate-y-0.5 active:translate-y-0"
          >
            <FaClock className="w-6 h-6 flex-shrink-0" />
